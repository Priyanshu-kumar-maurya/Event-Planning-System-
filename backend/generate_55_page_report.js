...
const imgHero = getBase64Img('media_1789058465565.png');
const imgCatalog = getBase64Img('media_1789058488827.png');
const imgStats = getBase64Img('media_1789058504678.png');
const imgFeatures = getBase64Img('media_1789058518318.png');
const imgCards = getBase64Img('media_1789058538503.png');
...
<div class="page-break">
  ...
  <table class="content-table">
    ...
    <tbody>
      ...
      <tr><td>Figure 8.6</td><td>Event Details Page Layout & Strict Login Gatekeeper Card</td><td>53</td></tr>
      <tr><td>Figure 8.7</td><td>Event Creation Studio with Past-Date Calendar Guard & Live Preview</td><td>54</td></tr>
      <tr><td>Figure 8.8</td><td>In-Place Event Schedule & Venue Modification Studio</td><td>55</td></tr>
      <tr><td>Figure 8.9</td><td>Administrator Analytics & 1-Click Attendee CSV Roster Engine</td><td>56</td></tr>
      <tr><td>Figure 9.1</td><td>Comprehensive Entity-Relationship (ER) Diagram of EventHub</td><td>57</td></tr>
    </tbody>
  </table>
</div>
...
<div class="page-break">
  ...
  <table class="content-table">
    ...
    <tbody>
      ...
      <tr><td>Table 10.1</td><td>Exhaustive Software Testing Matrix (Test Cases TC-01 to TC-25)</td><td>59</td></tr>
      <tr><td>Table 10.2</td><td>Security Boundary & Vulnerability Penetration Test Results</td><td>63</td></tr>
    </tbody>
  </table>
</div>
...
<div class="page-break">
  ...
  <div class="screenshot-figure">
    <img src="${imgHero}" alt="Home Page Hero Section">
  </div>
...
<div class="page-break">
  ...
  <div class="screenshot-figure">
    <img src="${imgCatalog}" alt="Events Catalog & Category Pills">
  </div>
...
<div class="page-break">
  ...
  <div class="screenshot-figure">
    <img src="${imgStats}" alt="Platform Metrics & Featured Events">
  </div>
...
<div class="page-break">
  ...
  <div class="screenshot-figure">
    <img src="${imgFeatures}" alt="Features Grid">
  </div>
...
<div class="page-break">
  ...
  <div class="screenshot-figure">
    <img src="${imgCards}" alt="Event Cards Grid">
  </div>
...
<div class="page-break">
  <h2 class="section-title">8.6 Event Details Page & Strict Login Gatekeeper UI</h2>
  <p>
    When a student selects "View Details &rarr;", they are navigated to the dedicated event page (<code>/events/:id</code>). Figure 8.6 depicts this interface:
  </p>

  <div class="diagram-box" style="text-align: left; padding: 15pt; font-size: 11pt;">
    <div style="background: #1e1b4b; color: #fff; padding: 8pt 12pt; border-radius: 4px; font-weight: bold; display: flex; justify-content: space-between;">
      <span>Tech Fest 2025 — Comprehensive Event Overview</span>
      <span>Status: Active Registration</span>
    </div>
    <div style="background: #f8fafc; padding: 12pt; border: 1px solid #cbd5e1; border-top: none; border-radius: 0 0 4px 4px;">
      <p class="no-indent"><strong>📅 Schedule:</strong> 15 Sept 2025 &nbsp;|&nbsp; <strong>⏰ Timing:</strong> 10:00 AM - 4:00 PM &nbsp;|&nbsp; <strong>📍 Venue:</strong> Delhi Convention Centre</p>
      <p class="no-indent"><strong>🏢 Organized By:</strong> Tech Club / Department of CSE &nbsp;|&nbsp; <strong>🎟️ Admission:</strong> Free</p>
      <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 10pt 0;">
      <p class="no-indent"><strong>Event Description:</strong> The biggest tech festival of the year! Join us for 3 days of innovation, hackathons, workshops, and inspiring keynotes from industry leaders across Google, Microsoft, and premier tech startups.</p>
      <div style="margin-top: 12pt; background: #ede9fe; padding: 10pt; border-radius: 6px; border: 1px solid #c4b5fd;">
        <strong>🔒 Login Gatekeeper Guard:</strong> If an unauthenticated guest clicks RSVP, an interactive padlock modal appears: <em>"Please log in with your verified student account to reserve your seat for this event."</em> [Log In] [Cancel]
      </div>
    </div>
  </div>
  <div class="figure-caption">Figure 8.6: Event Details Page Layout & Strict Login Gatekeeper Card</div>

  <h3 class="sub-section-title">Architectural & UI Breakdown:</h3>
  <ul>
    <li>
      <strong>Dynamic Parameter Loading:</strong> Employs React Router's <code>useParams()</code> hook to extract the event's <code>:id</code> and fetch full document details from <code>/api/events/:id</code>.
    </li>
    <li>
      <strong>Capacity Gauge:</strong> Renders real-time seat availability, warning participants when capacity falls below 20%.
    </li>
    <li>
      <strong>Registration Guard:</strong> Disables double-booking by verifying the current user's ID against the <code>registeredUsers</code> array, dynamically converting the action button to "Already Registered".
    </li>
  </ul>
</div>

<div class="page-break">
  <h2 class="section-title">8.7 Event Creation Studio & Future-Date Calendar Guard</h2>
  <p>
    Figure 8.7 illustrates the multi-section Event Creation Studio (<code>/create-event</code>). Designed to ensure comprehensive event metadata:
  </p>

  <div class="diagram-box" style="text-align: left; padding: 15pt; font-size: 11pt;">
    <div style="background: #1e1b4b; color: #fff; padding: 8pt 12pt; border-radius: 4px; font-weight: bold; display: flex; justify-content: space-between;">
      <span>Event Creation Studio — Multi-Section Form</span>
      <span>Sticky Live Preview: Active</span>
    </div>
    <div style="background: #f8fafc; padding: 12pt; border: 1px solid #cbd5e1; border-top: none; border-radius: 0 0 4px 4px;">
      <div style="display: flex; gap: 15pt;">
        <div style="flex: 1;">
          <p class="no-indent"><strong>1. Basic Details:</strong> Title, Category Dropdown, Description, Hosting Society.</p>
          <p class="no-indent"><strong>2. Schedule & Venue:</strong> Date Picker (<strong>min="${new Date().toISOString().split('T')[0]}"</strong>), Time, Hall Room.</p>
          <p class="no-indent"><strong>3. Capacity & Pricing:</strong> Maximum Seating Seats, Ticket Price (₹).</p>
          <p class="no-indent"><strong>4. Media Support:</strong> Image URL (Supports Instagram Post, Drive Link, CDN) + Category Preset Chips.</p>
        </div>
        <div style="width: 180pt; background: #0f172a; color: #fff; padding: 10pt; border-radius: 6px; font-size: 9.5pt;">
          <div style="color: #a855f7; font-weight: bold;">LIVE PREVIEW CARD</div>
          <div style="margin: 6pt 0; height: 60pt; background: #334155; border-radius: 4px; display: flex; align-items: center; justify-content: center;">[Live Banner]</div>
          <div style="font-weight: bold;">[Event Title]</div>
          <div style="color: #94a3b8; font-size: 8.5pt;">📅 [Date] &nbsp; 📍 [Venue]</div>
        </div>
      </div>
    </div>
  </div>
  <div class="figure-caption">Figure 8.7: Event Creation Studio with Past-Date Calendar Guard & Live Preview</div>

  <h3 class="sub-section-title">Architectural & UI Breakdown:</h3>
  <ul>
    <li>
      <strong>Calendar Guard (<code>min=Today</code>):</strong> Dynamically calculates today's date in <code>YYYY-MM-DD</code> format, locking past dates in the calendar picker to eliminate scheduling errors.
    </li>
    <li>
      <strong>Universal Media Link Normalizer:</strong> Accepts Instagram post URLs (<code>instagram.com/p/...</code>), extracting media endpoints and attaching <code>no-referrer</code> policies.
    </li>
    <li>
      <strong>Real-Time Sticky Card Mirror:</strong> Updates instantly on every keystroke, allowing organizers to preview how their event will appear on the homepage prior to publication.
    </li>
  </ul>
</div>

<div class="page-break">
  <h2 class="section-title">8.8 In-Place Event Schedule & Venue Modification Studio</h2>
  <p>
    When weather or logistical constraints require rescheduling, organizers utilize the In-Place Editor (<code>/events/:id/edit</code>). Figure 8.8 depicts this workflow:
  </p>

  <div class="diagram-box" style="text-align: left; padding: 15pt; font-size: 11pt;">
    <div style="background: #1e1b4b; color: #fff; padding: 8pt 12pt; border-radius: 4px; font-weight: bold; display: flex; justify-content: space-between;">
      <span>Modify Event Details — /events/:id/edit</span>
      <span>Authorization: Event Creator / Admin</span>
    </div>
    <div style="background: #f8fafc; padding: 12pt; border: 1px solid #cbd5e1; border-top: none; border-radius: 0 0 4px 4px;">
      <p class="no-indent"><strong>Loaded Existing Values:</strong> Title: "Tech Fest 2025" &nbsp;|&nbsp; Category: "Technology"</p>
      <p class="no-indent"><strong>Modify Timing:</strong> Updated from "10:00 AM" to <strong>"11:30 AM - 5:30 PM"</strong></p>
      <p class="no-indent"><strong>Modify Venue:</strong> Relocated from "Main Lawn" to <strong>"Auditorium Block B"</strong></p>
      <div style="margin-top: 10pt; text-align: right;">
        <span style="background: #7c3aed; color: #fff; padding: 6pt 14pt; border-radius: 4px; font-weight: bold;">Update Event in MongoDB &rarr;</span>
      </div>
    </div>
  </div>
  <div class="figure-caption">Figure 8.8: In-Place Event Schedule & Venue Modification Studio</div>

  <h3 class="sub-section-title">Architectural & UI Breakdown:</h3>
  <ul>
    <li>
      <strong>Pre-Populated Data Hydration:</strong> Fetches live parameters from MongoDB and pre-fills form fields via <code>useEffect</code>.
    </li>
    <li>
      <strong>Authorization Verification:</strong> Ensures that only the event creator (matching <code>createdBy</code>) or an administrator can dispatch <code>PUT /api/events/:id</code>.
    </li>
    <li>
      <strong>Immediate Global Propagation:</strong> Updates persist instantaneously, immediately reflecting across all student dashboards and public catalogs.
    </li>
  </ul>
</div>

<div class="page-break">
  <h2 class="section-title">8.9 Administrator Control Panel & 1-Click CSV Roster Engine</h2>
  <p>
    The Administrative Dashboard (<code>/admin</code>) equips faculty supervisors and college authorities with high-level platform oversight:
  </p>

  <div class="diagram-box" style="text-align: left; padding: 15pt; font-size: 11pt;">
    <div style="background: #1e1b4b; color: #fff; padding: 8pt 12pt; border-radius: 4px; font-weight: bold; display: flex; justify-content: space-between;">
      <span>Administrator Control Panel — Platform Telemetry & Roster Export</span>
      <span>Access Level: Super Admin</span>
    </div>
    <div style="background: #f8fafc; padding: 12pt; border: 1px solid #cbd5e1; border-top: none; border-radius: 0 0 4px 4px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 10pt;">
        <div style="background: #ede9fe; padding: 6pt 10pt; border-radius: 4px;"><strong>Total Events:</strong> 18</div>
        <div style="background: #ede9fe; padding: 6pt 10pt; border-radius: 4px;"><strong>Registrations:</strong> 1,155</div>
        <div style="background: #ede9fe; padding: 6pt 10pt; border-radius: 4px;"><strong>Active Students:</strong> 842</div>
        <div style="background: #ede9fe; padding: 6pt 10pt; border-radius: 4px;"><strong>Revenue:</strong> ₹42,500</div>
      </div>
      <table class="content-table" style="margin: 6pt 0;">
        <thead>
          <tr>
            <th>Event Title</th>
            <th>Organizer</th>
        ...
        <tbody>
          <tr>
            ...
            <td>500</td>
            <td>312 Attendees</td>
            <td><strong>[Export CSV]</strong> [Edit] [Delete]</td>
          </tr>
          <tr>
  ...
  <div class="figure-caption">Figure 8.9: Administrator Analytics & 1-Click Attendee CSV Roster Engine</div>

  <h3 class="sub-section-title">Architectural & UI Breakdown:</h3>
  <ul>
    <li>
      <strong>Client-Side CSV Generator:</strong> Compiles attendee records into RFC 4180-compliant CSV text blobs, initiating instantaneous downloads via <code>URL.createObjectURL()</code>.
    </li>
    <li>
      <strong>Structured Fields:</strong> Output CSV includes <code>Student Name</code>, <code>Email Address</code>, <code>College Name</code>, <code>Contact Phone</code>, and <code>Registration Timestamp</code>.
    </li>
  </ul>
</div>
...
<div class="page-break">
  ...
  <div class="diagram-box">
    <svg width="100%" height="400" viewBox="0 0 650 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Relationship: REGISTERS_FOR (M:N) -->
...
async function buildPdf() {
  ...
  console.log('Loading HTML document into browser...');
  await page.goto('file:///' + htmlPath.replace(/\\\\/g, '/'), {
    waitUntil: 'networkidle0',
    timeout: 60000,
  });

  console.log('Compiling academic PDF...');
  await page.pdf({
    path: outputPath,
    format: 'A4',
